...
This document analyzes the relationships between the different countries present in our dataset.
...
```{r define-relationships, echo=FALSE}
...
```{r find-relationships, echo=FALSE}
...
```{r chord-diagram, echo=FALSE, message=FALSE, warning=FALSE, results='hide', fig.width=12, fig.height=12}
...
title(main = "World Region Relationships",
      cex.main = 1.8,
      font.main = 2)
```
