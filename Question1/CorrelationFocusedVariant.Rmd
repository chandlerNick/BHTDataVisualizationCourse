...
In this section, we focus on the question: "How do selected human-geographic indicators relate to one another and how do different continents compare with respect to these indicators?".
...
Through this analysis, we sought to answer the question: “How do selected human-geographic indicators relate to one another
and how do different continents compare with respect to these indicators?” To do so, we examined linear and monotonic correlation between the variables themselves with Corrplots and continent/country-specific information, aggregated with PCA.
